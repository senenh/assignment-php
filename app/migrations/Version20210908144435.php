 ...
 */
final class Version20210908144435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_37FC770D14553382F1BAF49CAA2B25 ON key_language_translation (key_id, language_id, translation_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_37FC770D14553382F1BAF49CAA2B25 ON key_language_translation');
